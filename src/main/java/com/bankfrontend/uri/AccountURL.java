...
public class AccountURL {
    ...
    public URI makeDepositURI(Long accountId, double quote) {
        return UriComponentsBuilder.fromHttpUrl(AppStatics.BASE_URL + "/account/deposit")
    ...
    public URI withdrawalURI(Long accountId, double quote) {
        return UriComponentsBuilder.fromHttpUrl(AppStatics.BASE_URL + "/account/withdrawal")
                .queryParam("accountId", accountId)
                .queryParam("quote", quote)
                .build().encode().toUri();
    }
    ...
    public URI saveAccountURI(Currency currency, Long userId) {
        return UriComponentsBuilder.fromHttpUrl(AppStatics.BASE_URL + "/account")
    ...
    public URI getAccountsForUserURI(Long userId) {
        return UriComponentsBuilder.fromHttpUrl(AppStatics.BASE_URL + "/accounts")
                .queryParam("userId", userId)
                .build().encode().toUri();
    }

    public URI getCashBalanceForCurrencyURI(Currency currency, Long userId) {
        return UriComponentsBuilder.fromHttpUrl(AppStatics.BASE_URL + "/account/currencyCash")
                .queryParam("userId", userId)
                .queryParam("currency", currency)
                .build().encode().toUri();
    }
